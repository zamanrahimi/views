...
<form name="search_form" id="search_form" method="post" action="javascript: load_page_wform('<?=base_url()?>users/block_users/for_search','userajaxdiv','search_form');"  />
...
<tr>
    ...
    <td>
        ...
        <input type="button" name="search" id="search" class="searchButton" onclick="javascript: load_page_wform('<?=base_url()?>users/block_users/for_search','userajaxdiv','search_form');" value="<?=$this->lang->line('search')?>" />
