...
<table cellpadding="0" cellspacing="0" width="100%" class="tabledottted" border="1">
	<tr>
		<th class="tdstyledotted txtlabel" bgcolor="#DDDDDD">
		...
		<th class="tdstyledotted txtlabel" width="16%" bgcolor="#DDDDDD">
			<?=$this->lang->line('user_job')?>
		</th>
		<th class="tdstyledotted txtlabel" width="10%" bgcolor="#DDDDDD">
			<?=$this->lang->line('user_status')?>
		</th>
		<th colspan="2" class="tdstyledotted txtlabel" width="14%" colspan="2" bgcolor="#DDDDDD">
