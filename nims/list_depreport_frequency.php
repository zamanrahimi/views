...
<table cellpadding="0" cellspacing="0" class="dashboardtable"> 
            <tr>
                ...
                <select id="depreport_freq" name="depreport_freq" style="max-width:70px" onchange="javascript:bring_page('<?=base_url()?>dboard/home/etc/report_frequency_dep/300000/','depreport_freq','depid','depreportfrequencydiv','');">
...
<td class="vncellt" style="max-width:22px"><?=$this->lang->line('nims_department')?></td>
...
<td width="20%" class="listr"><strong><?=$evaluatedaverage['dep']?></strong></td>
<?php
