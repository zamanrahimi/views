...
<table cellpadding="0" cellspacing="0" class="dashboardtable"> 
            <tr>
                ...
                <select id="depcase_freq" name="depcase_freq" style="max-width:70px" onchange="javascript:bring_page('<?=base_url()?>dboard/home/etc/case_frequency_dep/300000/','depcase_freq','depid','depcasefrequencydiv','');">
