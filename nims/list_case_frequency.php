...
<table cellpadding="0" cellspacing="0" class="dashboardtable"> 
            <tr>
                ...
                <select id="case_freq" name="case_freq" style="max-width:70px" onchange="javascript:bring_page('<?=base_url()?>dboard/home/etc/case_frequency/300000/','case_freq','uid','casefrequencydiv','');">
